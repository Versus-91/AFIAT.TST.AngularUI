...
export class FacilityTypesComponent extends AppComponentBase {
    @ViewChild('createOrEditFacilityTypeModal', { static: true })
    createOrEditFacilityTypeModal: CreateOrEditFacilityTypeModalComponent;
    @ViewChild('viewFacilityTypeModalComponent', { static: true })
    viewFacilityTypeModal: ViewFacilityTypeModalComponent;
    ...
    constructor(
        ...
        super(injector);
        this.setTitle(this.l('FacilitiesTypes'));
    }
    ...
    deleteFacilityType(facilityType: FacilityTypeDto): void {
        this.message.confirm('', this.l('AreYouSure'), (isConfirmed) => {
            if (isConfirmed) {
                this._facilityTypesServiceProxy.delete(facilityType.id).subscribe(() => {
                    this.reloadPage();
